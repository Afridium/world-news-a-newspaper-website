...
const LoginPage = () => {
    ...
    const navigate = useNavigate(); //hook used to navigate, usually used when we use location and state
        ...
        <div className="min-h-screen flex items-center justify-center bg-base-200 p-4 text-primary">
            <div className="bg-white w-full max-w-lg rounded-xl shadow-lg p-10">
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    {/* Error Message */}
                    {error && (
                        <p className="text-red-500 text-sm text-center">Password is Incorrect</p>
                    )}
                ...
                {/* Login with socials */}
                <div className='grid grid-cols-1 gap-1 px-1 mt-6'>
                    {/* Google */}
